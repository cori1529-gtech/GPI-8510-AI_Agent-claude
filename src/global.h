...
#define	MONITORING_SERVER_IP	"112.217.212.250" // original gpi-8310 sugip server
#define	MONITORING_SERVER_PORT	8391
//#define	MONITORING_SERVER_IP	"112.222.115.165" // kwak's notebook  유선,노트북에서 무선을 끄고 해야한다.

//#define	MONITORING_SERVER_PORT	3333
...
#define	GET_TIME_INTERFAL_TIME		    	(DEF_1_MIN*1)	//1 min  몇분마다 현재시간 및 날짜를 읽어올 것인가 
