...
/*
	switch(number)
	{
		case 1: sprintf(str_1, "WEIGHT BACK UP       : %6ld",curr_num); break;
		case 2: sprintf(str_1, "END DELAY            : %6ld",curr_num); break;
		case 3: sprintf(str_1, "COMPENSATION WEIGHT  : %6ld",curr_num); break;
		case 4: sprintf(str_1, "DATA SENDING TIME_1  : %6ld",curr_num); break;
		case 5: sprintf(str_1, "DATA SENDING TIME_2  : %6ld",curr_num); break;
		case 6: sprintf(str_1, "DATA SENDING TIME_3  : %6ld",curr_num); break;
		case 7: sprintf(str_1, "LOADCELL NUMBER      : %6ld",curr_num); break;
		case 8: sprintf(str_1, "REAL WEIGHT FACTOR   : %6ld",curr_num); break;
		case 9: sprintf(str_1, "DISPLAY SELECTION    : %6ld",curr_num); break;
		//serial no 2016.4.4
		case 10: sprintf(str_1, "Serial No (MYYMMNNN) : M%07ld",curr_num); break;
		//jangbi id(address) 2016.4.4
		case 11: sprintf(str_1, "ID (ADDRESS : M999)  : M%03ld",curr_num); break;
		default: break;
	}// of switch
*/	
